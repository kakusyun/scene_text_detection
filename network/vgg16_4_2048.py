...
def network_cnn(inputs):
    ...
    # Block 5
    x = Conv2D(1024, (3, 3), activation='relu', padding='same', name='block5_conv1', kernel_initializer='he_normal')(x)
    x = Conv2D(1024, (3, 3), activation='relu', padding='same', name='block5_conv2', kernel_initializer='he_normal')(x)
    x = Conv2D(1024, (3, 3), activation='relu', padding='same', name='block5_conv3', kernel_initializer='he_normal')(x)
    # x = MaxPooling2D((2, 2), strides=(2, 2), name='block5_pool')(x)

    x = Conv2D(2048, (1, 1), activation='relu', padding='same', name='bottleneck_1', kernel_initializer='he_normal')(x)
